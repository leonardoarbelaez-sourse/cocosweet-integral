        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center bg-white rounded-3xl p-6 sm:p-10 shadow-lg border border-[#E5DFD5]">
          <div className="lg:col-span-5 space-y-6">
            <div className="relative group overflow-hidden rounded-2xl bg-stone-900 aspect-4/3 shadow-md">
              <img src={heroImage} alt="Crema de Coco Gourmet CocoSweet Integral" className="w-full h-full object-cover transition-transform duration-500 filter brightness-95" />
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white"><p className="text-xs uppercase tracking-widest text-amber-300 font-semibold">Pacífico colombiano</p><h3 className="font-serif text-xl font-bold">Crema de Coco Gourmet</h3></div>
            </div>
